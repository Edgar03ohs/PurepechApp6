...
public class EjerciciosCuerpoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int [] mEjerciciosImg = {R.drawable.dcabello, R.drawable.dcabeza, R.drawable.dmano, R.drawable.dpie, R.drawable.dojo};
    private String [] mEjerciciosStr = {"jauiri", "éjpu", "jájki", "jantsiri", "éskua" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicios_cuerpo);
