...
public class EjerciciosVerbosActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int [] mEjerciciosImg = {R.drawable.fcomer, R.drawable.fcorrer, R.drawable.fjugar, R.drawable.fsaludar, R.drawable.fver};
    private String [] mEjerciciosStr = {"t´ireni", "uiriani", "ch´anani", "uandajpani", "exeni" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicios_verbos);
